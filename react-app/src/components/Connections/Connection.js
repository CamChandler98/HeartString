            ...
            <div className = 'connection-content'>
                <div>
                    <div className = 'user-text-picture-card' >
                        ...
                        <img className ='connected-profile-picture' src = {connectedHeart.user_profile_pic} alt ={`your profile`}/>
                    ...
                    <div className = 'user-text-picture-card'>
                        ...
                        <img className ='connected-profile-picture' src = {connectedHeart.connector.profile_picture_url} alt ={`connection ${connectedHeart.connector.username} profile`}/>
